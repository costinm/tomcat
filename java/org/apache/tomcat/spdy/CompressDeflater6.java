...
class CompressDeflater6 implements CompressSupport {
    ...
    final byte[] SPDY_DICT3 = new byte[] {
    ...
    // TODO: pass version, single compressor needed
    public void init(int version) {
        ...
        try {
            ...
            zipOut.setDictionary(version == 2 ? SPDY_DICT : SPDY_DICT3);
            ...
            try {
                ...
                if (rd == 0 && zipIn.needsDictionary()) {
                    if (frame.version == 2) {
                        ...
                        zipIn.setDictionary(SPDY_DICT3);                        
                    }
                    continue;
                }
